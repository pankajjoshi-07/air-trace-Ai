...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navItems = [
    ...
    { name: 'Satellite Data', path: '/satellite-data', icon: Globe2 },
    { name: 'AI Columnar to Surface', path: '/satellite-to-surface', icon: Cpu },
    { name: 'CPCB Surface AQI', path: '/cpcb-aqi', icon: FileText },
